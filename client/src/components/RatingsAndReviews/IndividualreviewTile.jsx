...
var IndividualReviewTile = (props) => (
  ...
  <div id="indvRevContainer">
    ...
    <div id="review-recommend"> Would you recommended this product?: {props.recommend ? "Yes, I would recommend this product!" : "No , I would not recommend this product!"} </div>
